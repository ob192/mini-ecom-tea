...
// Pre-render a static page for every product.
        ...
        <div className="lg:min-w-0">
          <div className="px-[18px] pt-[18px] pb-1 lg:px-0 lg:pt-0">
            <div className="flex gap-2 mb-3">
              <span className="font-display font-medium text-[11px] tracking-wider uppercase px-[9px] py-[3px] rounded-full bg-green-tint text-green-deep">
                {categoryLabel(product.category)}
              </span>
              {product.inStock ? (
                <span className="font-display font-medium text-[11px] tracking-wider uppercase px-[9px] py-[3px] rounded-full bg-green-tint text-ok">
                  В наявності
                </span>
              ) : (
                <span className="font-display font-medium text-[11px] tracking-wider uppercase px-[9px] py-[3px] rounded-full bg-danger-tint text-danger">
                  Немає
                </span>
              )}
            </div>

            <h1 className="font-display font-semibold text-[27px] lg:text-[34px] leading-tight text-ink">{product.name}</h1>
            ...
            <div className="flex items-baseline gap-2.5 mt-4 mb-[18px]">
              <span className="font-display font-semibold text-[30px] lg:text-[36px] text-green-deep">{uah(product.price)}</span>
            ...
            <dl className="bg-card rounded-lg shadow-sh-1 overflow-hidden mb-[18px] m-0">
              ...
              {product.origin ? (
                <>
                  <SpecRow k="Походження" v={product.origin} />
                  <hr className="divider" />
                </>
              ) : null}
            ...
            <p className="m-0 text-ink-soft text-[15.5px] lg:text-[16px] leading-relaxed text-pretty">{product.description}</p>
          </div>
